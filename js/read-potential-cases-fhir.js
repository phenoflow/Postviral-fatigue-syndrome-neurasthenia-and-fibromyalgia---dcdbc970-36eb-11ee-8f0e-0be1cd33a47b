...
(async () => {
  ...
  await fs.writeFile("postviral-fatigue-syndrome-neurasthenia-and-fibromyalgia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("postviral-fatigue-syndrome-neurasthenia-and-fibromyalgia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
